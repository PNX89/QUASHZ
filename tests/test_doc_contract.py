...
IMPLEMENTATIONS: dict[str, str] = {
    "NUMBER": "test_the_numbers_on_the_page_are_the_measured_ones",
    "COMMAND": "test_every_command_the_page_offers_is_one_ci_runs",
    "OUTPUT": "test_every_block_quoted_from_a_transcript_is_in_that_transcript",
    "REFERENCE": "test_every_path_and_link_on_the_page_exists",
}
...
def _resolves(claim: str) -> bool:
    ...
    `quashz/thing.py` because that is the import path a reader types, and the file is at
    `src/quashz/thing.py`. Both are correct and a check that refused the first would be wrong.
    """
